...
### 🔗 [**Live App**](https://meal-planner-system-seven.vercel.app/)

> Demo account: `test@example.com` / `12345678`
> A meal plan is already generated for this account. Generating a new one is async (polling-based) — the UI shows a loading indicator and may take up to 5 minutes due to the LLM call.
