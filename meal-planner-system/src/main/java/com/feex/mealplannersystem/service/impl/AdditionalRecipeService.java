...
public class AdditionalRecipeService {
    ...
    public List<AdditionalRecipeDto> getAdditionalRecipes(
        ...
        RecipeFilterService.FilterResult filtered =
    ...
    private AdditionalRecipeDto toDto(ScoredAdditional s) {
    ...
    private record ScoredAdditional(RecipeModel recipe, NutritionModel nutrition, int score) {}
