...
public class EstimatedDailyMacros {
    ...
    public int getProteinMinG() {
        return proteinMinG;
    }

    public int getProteinMaxG() {
        return proteinMaxG;
    }
    ...
    public int getFatMinG() {
        return fatMinG;
    }

    public int getFatMaxG() {
        return fatMaxG;
    }
    ...
    public int getCarbsAbsoluteMinG() {
        return carbsAbsoluteMinG;
    }

    public boolean isLowCarbWarning() {
        return lowCarbWarning;
    }

    public int getProteinCoveragePercent() {
        return proteinCoveragePercent;
    }
    ...
    public boolean isCriticalProteinWarning() {
        return criticalProteinWarning;
    }

    public int getCarbsCoveragePercent() {
        return carbsCoveragePercent;
    }
    ...
    public int getFatCoveragePercent() {
        return fatCoveragePercent;
    }
